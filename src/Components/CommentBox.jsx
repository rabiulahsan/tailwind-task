  ...
  return (
    <div className="bg-[#ffffff] p-4 flex justify-between gap-x-2">
      ...
      <input
        ...
        className="border border-gray-200 rounded-md w-[75%]  px-4 py-2  placeholder:text-gray-500 placeholder:font-semibold placeholder:text-sm"
      />
      <button className="bg-[#5358b6] text-white rounded-md  px-5 py-2 font-semibold text-sm">
        SEND
      </button>
    </div>
  );
